...
CREATE TABLE `account` (
  ...
  `account_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `phone_num` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `contract_tbl` (
  ...
  `baranggay` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `municipality` varchar(50) NOT NULL,
  `province` varchar(50) NOT NULL,
  `penro` varchar(20) NOT NULL,
  `cenro` varchar(20) NOT NULL,
  `component` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `commodity` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `species` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `seed_reqdisplay` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `data_tbl` (
  ...
  `unique_code` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `target_area` decimal(10,0) NOT NULL,
  `area_planted` decimal(10,2) NOT NULL,
  `seed_req` int NOT NULL,
  `seed_pro` int NOT NULL,
  `seed_plant` int NOT NULL,
  `polygon_covered` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `date_ticinspection_tbl` (
  `date_inspection_id` int NOT NULL,
  `unique_code` varchar(100) NOT NULL,
...
CREATE TABLE `disbursement_2nd` (
  `disbursement_2nd_id` int NOT NULL,
  `unique_code` varchar(100) DEFAULT NULL,
...
CREATE TABLE `disbursement_3rd_mf` (
  `disbursement_3rd_id` int NOT NULL,
  `unique_code` varchar(100) DEFAULT NULL,
  `cheque_num` int DEFAULT NULL,
  `payment` int DEFAULT NULL,
  `date_issued` date DEFAULT NULL,
...
CREATE TABLE `disbursement_76_tbl` (
  `disbursement_76_id` int NOT NULL,
  `unique_code` varchar(100) DEFAULT NULL,
  `cheque_num` int DEFAULT NULL,
  `payment` int DEFAULT NULL,
  `date_issued` date DEFAULT NULL,
...
CREATE TABLE `disbursement_yearend_tbl` (
  `disbursement_yearend_id` int NOT NULL,
  `unique_code` varchar(100) DEFAULT NULL,
  `cheque_num` int DEFAULT NULL,
  `payment` int DEFAULT NULL,
  `date_issued` date DEFAULT NULL,
...
CREATE TABLE `disturbances_tbl` (
  `disturbances_id` int NOT NULL,
  `unique_code` varchar(100) NOT NULL,
  `date_occurence` date NOT NULL,
  `area_damaged` int NOT NULL,
...
CREATE TABLE `multispecies` (
  ...
  `multiseed_req` int NOT NULL,
  `tic_counted` int DEFAULT NULL,
...
CREATE TABLE `ngpalldate` (
  ...
  `CENRO` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `PENRO` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `Municipality` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `Barangay` varchar(73) DEFAULT NULL,
  `Name_of_Org` varchar(86) DEFAULT NULL,
  `Contact_Person` varchar(40) DEFAULT NULL,
  `Type_org` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `Tenure` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  ...
  `Dis_area_dam` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE `projectcost_tbl` (
  ...
  `unique_code` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `polygon_code` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `survival_rate_year1` (
  ...
  `no_seedling_planted` int NOT NULL,
  `no_seedling_survive` int NOT NULL,
  `survival_rate` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `year1_disbursement` (
  `year1_id` int NOT NULL,
  `unique_code` varchar(100) NOT NULL,
  `1st_payment` int NOT NULL,
  `2nd_payment` int DEFAULT NULL,
  `3rd_payment` int DEFAULT NULL,
  `4th_payment` int DEFAULT NULL,
  `totalcost` decimal(10,0) DEFAULT NULL,
  `retention_fund` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `year2nd_data_tbl` (
  `year2_data_id` int NOT NULL,
  `unique_code` varchar(100) DEFAULT NULL,
  `filter_code` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `quarter_code` varchar(10) DEFAULT NULL,
  `type_code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `commodity` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `quantity` int DEFAULT NULL,
  `unit` int DEFAULT NULL,
  `total_cost` decimal(10,0) DEFAULT NULL,
  `accomplished` int DEFAULT NULL,
...
CREATE TABLE `year2_remarks` (
  ...
  `quarter_code` varchar(20) DEFAULT NULL,
  `filter_code` varchar(6) DEFAULT NULL,
  `remark` varchar(10000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `year3rd_data_tbl` (
  `year3_data_id` int NOT NULL,
  `unique_code` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `filter_code` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `quarter_code` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `type_code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `commodity` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `quantity` int DEFAULT NULL,
  `unit` int DEFAULT NULL,
...
--
ALTER TABLE `activities_tbl`
  MODIFY `activities_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `commodity_tbl`
--
ALTER TABLE `commodity_tbl`
  MODIFY `commodity_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `commodity_unitcost_tbl`
--
ALTER TABLE `commodity_unitcost_tbl`
  MODIFY `commodity_unitcost_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=381;

--
-- AUTO_INCREMENT for table `component_tbl`
--
ALTER TABLE `component_tbl`
  MODIFY `component_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `contact_tbl`
--
ALTER TABLE `contact_tbl`
  MODIFY `Contact_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT for table `contract_tbl`
--
ALTER TABLE `contract_tbl`
  MODIFY `contract_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=363;

--
-- AUTO_INCREMENT for table `data_tbl`
--
ALTER TABLE `data_tbl`
  MODIFY `data_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=361;

--
-- AUTO_INCREMENT for table `date_ticinspection_tbl`
--
ALTER TABLE `date_ticinspection_tbl`
  MODIFY `date_inspection_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `date_turnover_tbl`
--
ALTER TABLE `date_turnover_tbl`
  MODIFY `turn_over_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `date_validation_report`
--
ALTER TABLE `date_validation_report`
  MODIFY `validation_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=211;

--
-- AUTO_INCREMENT for table `disbursement_2nd`
--
ALTER TABLE `disbursement_2nd`
  MODIFY `disbursement_2nd_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `disbursement_3rd_mf`
--
ALTER TABLE `disbursement_3rd_mf`
  MODIFY `disbursement_3rd_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `disbursement_76_tbl`
--
ALTER TABLE `disbursement_76_tbl`
  MODIFY `disbursement_76_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `disbursement_tbl`
--
ALTER TABLE `disbursement_tbl`
  MODIFY `disbursement_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `disbursement_yearend_tbl`
--
ALTER TABLE `disbursement_yearend_tbl`
  MODIFY `disbursement_yearend_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `disturbances_tbl`
--
ALTER TABLE `disturbances_tbl`
  MODIFY `disturbances_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;

--
-- AUTO_INCREMENT for table `flexible_disbursement_tbl`
--
ALTER TABLE `flexible_disbursement_tbl`
  MODIFY `disbursement_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT for table `funding_tbl`
--
ALTER TABLE `funding_tbl`
  MODIFY `funding_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `inspector_details_tbl`
--
ALTER TABLE `inspector_details_tbl`
  MODIFY `inspector_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;

--
-- AUTO_INCREMENT for table `maintenance_pro_tbl`
--
ALTER TABLE `maintenance_pro_tbl`
  MODIFY `main_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `maintenance_tbl`
--
ALTER TABLE `maintenance_tbl`
  MODIFY `maintenance_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `multispecies`
--
ALTER TABLE `multispecies`
  MODIFY `multispecies_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=326;

--
-- AUTO_INCREMENT for table `organizational_tbl`
--
ALTER TABLE `organizational_tbl`
  MODIFY `Org_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT for table `plantation_estab_tbl`
--
ALTER TABLE `plantation_estab_tbl`
  MODIFY `plantation_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `polygon_tbl`
--
ALTER TABLE `polygon_tbl`
  MODIFY `polygon_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `projectcost_tbl`
--
ALTER TABLE `projectcost_tbl`
  MODIFY `cost_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=284;

--
-- AUTO_INCREMENT for table `remarks`
--
ALTER TABLE `remarks`
  MODIFY `remarks_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `seedplanted_tbl`
--
ALTER TABLE `seedplanted_tbl`
  MODIFY `seed_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `seedproduction_tbl`
--
ALTER TABLE `seedproduction_tbl`
  MODIFY `seed_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=290;

--
-- AUTO_INCREMENT for table `site_status_tbl`
--
ALTER TABLE `site_status_tbl`
  MODIFY `site_status_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=259;

--
-- AUTO_INCREMENT for table `species_tbl`
--
ALTER TABLE `species_tbl`
  MODIFY `species_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `status_registry`
--
ALTER TABLE `status_registry`
  MODIFY `registry_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;

--
-- AUTO_INCREMENT for table `survival_rate_year1`
--
ALTER TABLE `survival_rate_year1`
  MODIFY `survival_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `survival_rate_year2`
--
ALTER TABLE `survival_rate_year2`
  MODIFY `survival_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `survival_rate_year3`
--
ALTER TABLE `survival_rate_year3`
  MODIFY `survival_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=222;

--
-- AUTO_INCREMENT for table `year1_disbursement`
--
ALTER TABLE `year1_disbursement`
  MODIFY `year1_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `year2nd_data_tbl`
--
ALTER TABLE `year2nd_data_tbl`
  MODIFY `year2_data_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;

--
-- AUTO_INCREMENT for table `year2nd_inspection_date`
--
ALTER TABLE `year2nd_inspection_date`
  MODIFY `year2_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `year2_remarks`
--
ALTER TABLE `year2_remarks`
  MODIFY `remarks_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `year3rd_data_tbl`
--
ALTER TABLE `year3rd_data_tbl`
  MODIFY `year3_data_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT for table `year3rd_inspection_date`
--
ALTER TABLE `year3rd_inspection_date`
  MODIFY `year3_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `year3_remarks`
--
ALTER TABLE `year3_remarks`
  MODIFY `remarks_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
