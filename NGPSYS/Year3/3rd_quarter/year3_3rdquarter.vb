...
Public Class year3_3rdquarter
    Private Sub year3_3rdquarter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
            ...
            Using reader As MySqlDataReader = command.ExecuteReader()
                ...
                While reader.Read()
                    ...
                    If Decimal.TryParse(reader.GetString(7), totalcost) Then
                        row.Cells(4).Value = unit.ToString("N")
                    Else
    ...
    Public Sub LoadReportquarter3()
        ...
        Try
            year3_quarter3_Report_.ReportViewer1.RefreshReport()

            ' Load report files
            With year3_quarter3_Report_.ReportViewer1.LocalReport
                .ReportPath = Application.StartupPath & "\report\year3_quarter3_MP.rdlc"
                .DataSources.Clear()
            End With
            ...
            Using connection As New MySqlConnection(connStr)
                ...
                daDetails.Fill(dsDetails, "quarter3dbrwrs")
                ...
                daReplanting.Fill(dsReplanting, "quarter3dbreplanting")
                ...
                daPatrol.Fill(dsPatrol, "quarter3dbpatrol")
                ...
                daSurvival.Fill(dsSurvival, "quarter3dbsurvival")
                ...
                rptDSDetails = New ReportDataSource("quarter3DBrwrs", dsDetails.Tables("quarter3dbrwrs"))
                rptDSReplanting = New ReportDataSource("quarter3DBreplanting", dsReplanting.Tables("quarter3dbreplanting"))
                rptDSPatrol = New ReportDataSource("quarter3DBpatrol", dsPatrol.Tables("quarter3dbpatrol"))
                rptDSSurvival = New ReportDataSource("quarter3DBsurvival", dsSurvival.Tables("quarter3dbsurvival"))
                year3_quarter3_Report_.ReportViewer1.LocalReport.DataSources.Add(rptDSDetails)
                year3_quarter3_Report_.ReportViewer1.LocalReport.DataSources.Add(rptDSReplanting)
                year3_quarter3_Report_.ReportViewer1.LocalReport.DataSources.Add(rptDSPatrol)
                year3_quarter3_Report_.ReportViewer1.LocalReport.DataSources.Add(rptDSSurvival)
            End Using

            ' Set display mode and zoom level
            year3_quarter3_Report_.ReportViewer1.SetDisplayMode(Microsoft.Reporting.WinForms.DisplayMode.PrintLayout)
            year3_quarter3_Report_.ReportViewer1.ZoomMode = ZoomMode.Percent
            year3_quarter3_Report_.ReportViewer1.ZoomPercent = 30
    ...
    Public Sub parameters()
        Try
            ...
            year3_quarter3_Report_.ReportViewer1.LocalReport.ReportPath = Application.StartupPath & "\report\year3_quarter3_MP.rdlc"

            ' Set the parameters to the ReportViewer control
            year3_quarter3_Report_.ReportViewer1.LocalReport.SetParameters(reportParameters)
    ...
    Private Sub btnprintreport_Click(sender As Object, e As EventArgs) Handles btnprintreport.Click
        LoadReportquarter3()
        parameters()
        year3_quarter3_Report_.ShowDialog()
    End Sub
