...
Public Class year3_4thquarter
    Private Sub year3_4thquarter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub LoadReportquarter4()
        ...
        Try
            year3_4quarter_Report.ReportViewer1.RefreshReport()

            ' Load report files
            With year3_4quarter_Report.ReportViewer1.LocalReport
                .ReportPath = Application.StartupPath & "\report\year3_4quarter_MP.rdlc"
                .DataSources.Clear()
            End With
            ...
            Using connection As New MySqlConnection(connStr)
                ...
                year3_4quarter_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSDetails)
                year3_4quarter_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSReplanting)
                year3_4quarter_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSPatrol)
                year3_4quarter_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSSurvival)
            End Using

            ' Set display mode and zoom level
            year3_4quarter_Report.ReportViewer1.SetDisplayMode(Microsoft.Reporting.WinForms.DisplayMode.PrintLayout)
            year3_4quarter_Report.ReportViewer1.ZoomMode = ZoomMode.Percent
            year3_4quarter_Report.ReportViewer1.ZoomPercent = 30
    ...
    Public Sub parameters()
        Try
            ...
            year3_4quarter_Report.ReportViewer1.LocalReport.ReportPath = Application.StartupPath & "\report\year2_4quarter_MP.rdlc"

            ' Set the parameters to the ReportViewer control
            year3_4quarter_Report.ReportViewer1.LocalReport.SetParameters(reportParameters)
    ...
    Private Sub btnprintreport_Click(sender As Object, e As EventArgs) Handles btnprintreport.Click
        LoadReportquarter4()
        parameters()
        year3_4quarter_Report.ShowDialog()
    End Sub
