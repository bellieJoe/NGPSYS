...
Public Class year3_replanting

    Dim totaltarget As Double
    Dim itcom As Integer
    Dim qty As Double
    Dim unit As Double
    Private Sub year3_replanting_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        PopulateComboBox()
    ...
    Private Sub RemoveSelectedItem()
        ...
        If cmbcom.SelectedIndex <> -1 Then
            ...
            If itcom <= 0 Then
                year3_patrolworks_inventory.Show(maindash)
                Me.Close()
