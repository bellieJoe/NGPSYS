...
Public Class year2_viewpayment_frm
    ...
    Private Sub year2_viewpayment_frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        user()
        ClearFormData()
        LoadData()
        displayprojectcost()
    ...
    Public Sub DisplayTotalAmount()
        Dim connectionString As String = "server=localhost;username=root;password=;database=ngp"
        Dim query As String = "SELECT SUM(total_payment) AS total_counted FROM flexible_disbursement_tbl WHERE unique_code = @id AND yearcode = 'year2';"
