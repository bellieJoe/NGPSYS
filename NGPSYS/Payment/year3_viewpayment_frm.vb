...
Public Class year3_viewpayment_frm
    ...
    Private Sub year3_viewpayment_frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        user()
        ClearFormData()
        LoadData()
        displayprojectcost()
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        ...
        lbltitle.Text = DataGridView1.Item("disbursement_code", DataGridView1.CurrentRow.Index).Value
    ...
    Public Sub DisplayTotalAmount()
        Dim connectionString As String = "server=localhost;username=root;password=;database=ngp"
        Dim query As String = "SELECT SUM(total_payment) AS total_counted FROM flexible_disbursement_tbl WHERE unique_code = @id AND yearcode = 'year3';"
    ...
    Private Sub YourFormName_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        DataSet.Clear()
    End Sub
End Class