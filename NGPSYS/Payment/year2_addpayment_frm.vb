...
Public Class year2_addpayment_frm
    ...
    Private Sub year2_addpayment_frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
            ...
            Else
                Using connection As New MySqlConnection(connectionString)
                    ...
                    Using command As New MySqlCommand(query, connection)
                        ...
                        command.Parameters.AddWithValue("@yearcode", "year2")
