...
Partial Class year2_addpayment_frm
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(year2_addpayment_frm))
        ...
        Name = "year2_addpayment_frm"
        StartPosition = FormStartPosition.CenterScreen
        Text = "year2_addpayment_frm"
