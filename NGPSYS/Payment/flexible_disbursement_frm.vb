...
Public Class flexible_disbursement_frm
    ...
    Private Sub flexible_disbursement_frm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
            ...
            Else
                Using connection As New MySqlConnection(connectionString)
                    ...
                    Using command As New MySqlCommand(query, connection)
                        ...
                        command.Parameters.AddWithValue("@yearcode", "year1")
