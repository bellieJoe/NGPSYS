...
Public Class component_maintenance

    Private Sub component_maintenance_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loaddatacom()

    End Sub

    Private Sub loaddatacom()
        Dim connectionString As String = "server=localhost;username=root;password=;database=ngp"

        ' SQL query to select data from the database
        Dim query As String = "SELECT component_id, component_name FROM component_tbl"
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            Using command As New MySqlCommand(query, connection)
                ...
                usersdata.Columns("component_name").HeaderText = "Component"

                ' Hide unwanted columns
                For Each column As DataGridViewColumn In usersdata.Columns
                    If column.Name <> "component_name" Then
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles usersdata.CellDoubleClick
        ...
        txtid.Text = selectedRow.Cells("component_id").Value.ToString()
        txtname.Text = selectedRow.Cells("component_name").Value.ToString()
    ...
    Private Sub UpdateData()
        ...
        Dim query As String = "UPDATE component_tbl SET component_name = @comnam WHERE component_id = @id"
    ...
    Private Sub DeleteData(id As Integer)
        ...
        Dim query As String = "DELETE FROM component_tbl WHERE component_id = @id"
