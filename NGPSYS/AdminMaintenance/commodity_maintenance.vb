...
Public Class commodity_maintenance
    Private Sub commodity_maintenance_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loaddatacommodity()
    End Sub

    Private Sub loaddatacommodity()
        Dim connectionString As String = "server=localhost;username=root;password=;database=ngp"

        ' SQL query to select data from the database
        Dim query As String = "SELECT commodity_id, commodity_name FROM commodity_tbl"
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            Using command As New MySqlCommand(query, connection)
                ...
                usersdata.Columns("commodity_name").HeaderText = "Commodity"

                ' Hide unwanted columns
                For Each column As DataGridViewColumn In usersdata.Columns
                    If column.Name <> "commodity_name" Then
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles usersdata.CellDoubleClick
        ...
        txtid.Text = selectedRow.Cells("commodity_id").Value.ToString()
        txtname.Text = selectedRow.Cells("commodity_name").Value.ToString()
    ...
    Private Sub UpdateData()
        ...
        Dim query As String = "UPDATE commodity_tbl SET commodity_name = @comnam WHERE commodity_id = @id"
    ...
    Private Sub DeleteData(id As Integer)
        ...
        Dim query As String = "DELETE FROM commodity_tbl WHERE commodity_id = @id"
