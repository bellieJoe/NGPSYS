...
Public Class Ongoingcon
    ...
    Private Sub Ongoingcon_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadData(Optional searchDigits As String = "")
        ...
        Using connection As New MySqlConnection(connectionString)
            Dim query As String = "SELECT t1.unique_code, DATE_FORMAT(t1.date_execution, '%M %Y') AS date_execution, DATE_FORMAT(t1.date_expiry, '%M %Y') AS date_expiry, t1.zone, t1.fund, t1.activities, t1.year, t1.region, t1.district, t1.baranggay, t1.municipality, t1.province, " &
              "t1.penro, t1.cenro, t1.component, t1.commodity, t1.species, t1.seed_reqdisplay, t2.data_id, t2.target_area, t2.area_planted, t2.seed_req, t2.seed_pro, t2.seed_plant, YEAR(NOW()) AS year, " &
              ...
              "LEFT JOIN date_turnover_tbl AS t5 ON t1.unique_code = t5.unique_code " &
              "WHERE  t1.year = year AND t5.unique_code IS NULL"

            If Not String.IsNullOrEmpty(searchDigits) Then
                query &= " AND t1.unique_code = @searchDigits"

            End If

            query &= " ORDER BY t1.unique_code ASC"
            ...
            Using cmd As New MySqlCommand(query, connection)
                ...
                Using adapter As New MySqlDataAdapter(cmd)
                    ...
                    If dataSet.Tables("YourTableName") IsNot Nothing AndAlso dataSet.Tables("YourTableName").Rows.Count > 0 Then
    ...
    Private Sub datafilter()
        DataGridView1.Columns("year1").Visible = False
    ...
    Private Sub Newtxtuniquecode_TextChanged(sender As Object, e As EventArgs) Handles Newtxtuniquecode.TextChanged
        Dim uniquecode As String = Newtxtuniquecode.Text
    ...
    Private Sub Populateyear(selectedYear As String)
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            If Not String.IsNullOrEmpty(selectedYear) Then
                query &= " WHERE t1.year = @selectedyear AND t5.unique_code IS NULL "
            End If
    ...
    Private Sub PopulatebyMuni(selectedmuni As String)
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            If Not String.IsNullOrEmpty(selectedmuni) Then
                query &= "WHERE t1.municipality = @selectedmuni AND t5.unique_code IS NULL;"
            End If
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        ongoing_details.selectedContract = "ONGOING"
    ...
    Private Sub Populatearea(selectedarea As String)
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            If Not String.IsNullOrEmpty(selectedarea) Then
                ...
                query &= "WHERE t2.area_planted = @selectedarea AND t5.unique_code IS NULL;"
            End If
    ...
    Private Sub Populateorg(org As String)
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            If Not String.IsNullOrEmpty(org) Then
                query &= "WHERE Org_name = @selectedorg AND t5.unique_code IS NULL;"
            End If
    ...
    Public Sub LoadConsolidatedProjectReporters(filterType As String, filterValue As String)
        ...
        Try
            ...
            Using connection As New MySqlConnection(connStr)
                ...
                "(SELECT GROUP_CONCAT(t9.survival_rate SEPARATOR ', ') " &
                " FROM survival_rate_year3 AS t9 " &
                " WHERE t9.unique_code = t1.unique_code) AS survival_rate, " &
                "t10.date_updated, t10.status AS status_site, t10.adopting_entity, " &
                "t11.area_damaged, t11.type_damage, t11.status, " &
                "t12.seed_code, t13.seed_produce_code, " &
                "(SELECT GROUP_CONCAT(multi.multispecies_name SEPARATOR ', ') " &
                " FROM multispecies AS multi " &
                " WHERE multi.seed_produce_code = t12.seed_code) AS multispecies_name " &
                "FROM contract_tbl AS t1 " &
                ...
                "WHERE " & GetFilterCondition(filterType) & " = @filterValue AND t14.unique_code IS NULL " &
