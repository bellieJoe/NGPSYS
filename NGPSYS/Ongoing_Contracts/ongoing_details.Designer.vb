...
Partial Class ongoing_details
    ...
    Private Sub InitializeComponent()
        ...
        ComprehensiveToolStripMenuItem = New ToolStripMenuItem()
        NdYearMaintenanceAndProtectionToolStripMenuItem = New ToolStripMenuItem()
        RdYearMaintenanceAndProtectionToolStripMenuItem = New ToolStripMenuItem()
        MaintenanceToolStripMenuItem = New ToolStripMenuItem()
        AddDateOfTurnOverToolStripMenuItem = New ToolStripMenuItem()
        AddDateOfPVDToolStripMenuItem = New ToolStripMenuItem()
        AddDisturbancesToolStripMenuItem = New ToolStripMenuItem()
        AddSurvivalRateToolStripMenuItem = New ToolStripMenuItem()
        MaintenanceToolStripMenuItem1 = New ToolStripMenuItem()
        StatusOfRegistryToolStripMenuItem = New ToolStripMenuItem()
        addstatus = New ToolStripMenuItem()
        viewstatus = New ToolStripMenuItem()
        ForestDisturbancesToolStripMenuItem = New ToolStripMenuItem()
        adddisturbance = New ToolStripMenuItem()
        viewdisturbance = New ToolStripMenuItem()
        StatusOfTheSiteToolStripMenuItem = New ToolStripMenuItem()
        addsitestatus = New ToolStripMenuItem()
        viewsitestatus = New ToolStripMenuItem()
        ProjectCostToolStripMenuItem = New ToolStripMenuItem()
        addprojectcost = New ToolStripMenuItem()
        ...
        txtconregion = New TextBox()
        Label27 = New Label()
        txtbarangay = New TextBox()
        txtorg = New TextBox()
        txtspe = New TextBox()
        newcontact = New TextBox()
        txtmunicipality = New TextBox()
        Label17 = New Label()
        txtcommodity = New TextBox()
        Label26 = New Label()
        txtyear = New TextBox()
        txtseedreq = New TextBox()
        txtcomponent = New TextBox()
        txttypeorg = New TextBox()
        dateofreport = New DateTimePicker()
        txtspecies = New TextBox()
        Label5 = New Label()
        sedd = New Label()
        txtseedplanted = New TextBox()
        Label29 = New Label()
        datecontractexe = New DateTimePicker()
        Label7 = New Label()
        Label19 = New Label()
        Label30 = New Label()
        Label4 = New Label()
        ...
        Label11 = New Label()
        Label13 = New Label()
        txtseedpro = New TextBox()
        txttenure = New TextBox()
        datecontractexp = New DateTimePicker()
        Label8 = New Label()
        Label18 = New Label()
        Label14 = New Label()
        txtreport = New TextBox()
        Label12 = New Label()
        dateofactual = New DateTimePicker()
        ...
        Panel1.Controls.Add(txtcountpoly)
        Panel1.Controls.Add(Label38)
        Panel1.Controls.Add(Label36)
        Panel1.Controls.Add(Button1)
        Panel1.Controls.Add(ProgressBar4)
        Panel1.Controls.Add(progress4)
        Panel1.Controls.Add(PictureBox4)
        Panel1.Controls.Add(Label33)
        Panel1.Controls.Add(txtprojectcost)
        Panel1.Controls.Add(GroupBox2)
        Panel1.Controls.Add(GroupBox1)
        Panel1.Controls.Add(Label20)
        Panel1.Controls.Add(txtyear3)
        Panel1.Controls.Add(Label15)
        Panel1.Controls.Add(txtyear2)
        Panel1.Controls.Add(Label9)
        Panel1.Controls.Add(txtyear1)
        Panel1.Controls.Add(Label1)
        Panel1.Controls.Add(lblprimarykey)
        Panel1.Controls.Add(MenuStrip1)
        Panel1.Controls.Add(Label2)
        Panel1.Controls.Add(txtuniquecode)
        Panel1.Controls.Add(condistricttxt)
        Panel1.Controls.Add(Label3)
        Panel1.Controls.Add(Label25)
        Panel1.Controls.Add(Label24)
        Panel1.Controls.Add(Label6)
        Panel1.Controls.Add(txtprovince)
        Panel1.Controls.Add(txtconregion)
        Panel1.Controls.Add(Label27)
        Panel1.Controls.Add(txtbarangay)
        Panel1.Controls.Add(txtorg)
        Panel1.Controls.Add(txtspe)
        Panel1.Controls.Add(newcontact)
        Panel1.Controls.Add(txtmunicipality)
        Panel1.Controls.Add(Label17)
        Panel1.Controls.Add(txtcommodity)
        Panel1.Controls.Add(Label26)
        Panel1.Controls.Add(txtyear)
        Panel1.Controls.Add(txtseedreq)
        Panel1.Controls.Add(txtcomponent)
        Panel1.Controls.Add(txttypeorg)
        Panel1.Controls.Add(dateofreport)
        Panel1.Controls.Add(txtspecies)
        Panel1.Controls.Add(Label5)
        Panel1.Controls.Add(sedd)
        Panel1.Controls.Add(txtseedplanted)
        Panel1.Controls.Add(Label29)
        Panel1.Controls.Add(datecontractexe)
        ...
        Panel1.Controls.Add(txtseedpro)
        Panel1.Controls.Add(txttenure)
        Panel1.Controls.Add(datecontractexp)
        Panel1.Controls.Add(Label8)
        Panel1.Controls.Add(Label18)
        Panel1.Controls.Add(Label14)
        Panel1.Controls.Add(txtreport)
        Panel1.Controls.Add(Label12)
        Panel1.Controls.Add(dateofactual)
        ...
        btnUploadDoc.Size = New Size(144, 50)
        ...
        ' ProgressBar4
        ' 
        ProgressBar4.Location = New Point(1013, 290)
        ProgressBar4.Name = "ProgressBar4"
        ProgressBar4.Size = New Size(234, 29)
        ProgressBar4.TabIndex = 225
        ProgressBar4.Visible = False
        ' 
        ' progress4
        ' 
        progress4.AutoCompleteCustomSource.AddRange(New String() {"admin", "guest"})
        progress4.BackColor = Color.DarkSeaGreen
        ...
        progress4.Location = New Point(1087, 150)
        ...
        PictureBox4.Location = New Point(1013, 67)
        PictureBox4.Margin = New Padding(3, 2, 3, 2)
        PictureBox4.Name = "PictureBox4"
        PictureBox4.Size = New Size(234, 209)
        PictureBox4.SizeMode = PictureBoxSizeMode.StretchImage
        PictureBox4.TabIndex = 223
        ...
        ' GroupBox2
        ' 
        GroupBox2.Controls.Add(txtunder)
        GroupBox2.Controls.Add(txtcip)
        GroupBox2.Controls.Add(Label34)
        GroupBox2.Controls.Add(Label35)
        GroupBox2.Location = New Point(937, 335)
        GroupBox2.Name = "GroupBox2"
        GroupBox2.Size = New Size(371, 208)
        GroupBox2.TabIndex = 220
        GroupBox2.TabStop = False
        GroupBox2.Text = "Status of Registry to the Book of Accounts"
        ' 
        ' txtunder
        ' 
        ...
        GroupBox1.Controls.Add(dateupdated)
        GroupBox1.Controls.Add(Label21)
        GroupBox1.Controls.Add(TxtAe)
        GroupBox1.Controls.Add(txtstatus)
        GroupBox1.Controls.Add(Label22)
        GroupBox1.Location = New Point(627, 573)
        GroupBox1.Name = "GroupBox1"
        GroupBox1.Size = New Size(518, 174)
        GroupBox1.TabIndex = 215
        GroupBox1.TabStop = False
        GroupBox1.Text = "Status of the Site"
        ' 
        ' Label23
        ' 
        ...
        ' 
        ' ComprehensiveToolStripMenuItem
        ' 
        ...
        btnPrintDoc.Size = New Size(115, 58)
    ...
    Friend WithEvents txttypeorg As TextBox
    Friend WithEvents Label26 As Label
    Friend WithEvents newcontact As TextBox
    Friend WithEvents Label27 As Label
    Friend WithEvents Label25 As Label
    Friend WithEvents condistricttxt As TextBox
    Friend WithEvents Label24 As Label
    Friend WithEvents txtconregion As TextBox
    Friend WithEvents txtorg As TextBox
    Friend WithEvents Label17 As Label
    Friend WithEvents Label1 As Label
    Friend WithEvents txtseedreq As TextBox
    Friend WithEvents dateofreport As DateTimePicker
    Friend WithEvents sedd As Label
    Friend WithEvents Label7 As Label
    Friend WithEvents txtarea As TextBox
    Friend WithEvents Label13 As Label
    Friend WithEvents Label8 As Label
    Friend WithEvents dateofactual As DateTimePicker
    Friend WithEvents Label12 As Label
    Friend WithEvents Label14 As Label
    Friend WithEvents datecontractexp As DateTimePicker
    Friend WithEvents Label11 As Label
    Friend WithEvents Label4 As Label
    Friend WithEvents datecontractexe As DateTimePicker
    ...
    Friend WithEvents ComprehensiveToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents NdYearMaintenanceAndProtectionToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents RdYearMaintenanceAndProtectionToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents Label16 As Label
    Friend WithEvents code As TextBox
    Friend WithEvents MaintenanceToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents AddDateOfTurnOverToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents AddDateOfPVDToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents AddDisturbancesToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents MaintenanceToolStripMenuItem1 As ToolStripMenuItem
    Friend WithEvents StatusOfRegistryToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents addstatus As ToolStripMenuItem
    Friend WithEvents viewstatus As ToolStripMenuItem
    Friend WithEvents ForestDisturbancesToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents adddisturbance As ToolStripMenuItem
    Friend WithEvents viewdisturbance As ToolStripMenuItem
    Friend WithEvents StatusOfTheSiteToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents addsitestatus As ToolStripMenuItem
    ...
    Friend WithEvents ProjectCostToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents addprojectcost As ToolStripMenuItem
    ...
    Friend WithEvents viewsitestatus As ToolStripMenuItem
    Friend WithEvents viewprojectcost As ToolStripMenuItem
    Friend WithEvents Label37 As Label
    Friend WithEvents txtcountpoly As TextBox
    Friend WithEvents NoOfSitesToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents addpoly As ToolStripMenuItem
