...
Partial Class Disbursement_2nd
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Disbursement_2nd))
        txtorg = New TextBox()
        ...
        txtorg.Location = New Point(186, 134)
        txtorg.Name = "txtorg"
        ...
        Label9.Location = New Point(13, 136)
        Label9.Name = "Label9"
        ...
        Label16.Size = New Size(510, 45)
        Label16.TabIndex = 179
        Label16.Text = "Summary Billing : Quarter 2"
        ' 
        ' txtretention
        ' 
        ...
        txtretention.Location = New Point(56, 222)
        ...
        ' txtmobilization
        ' 
        txtmobilization.AutoCompleteCustomSource.AddRange(New String() {"admin", "guest"})
        txtmobilization.BorderStyle = BorderStyle.FixedSingle
        txtmobilization.Font = New Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point)
        txtmobilization.ForeColor = Color.Black
        txtmobilization.Location = New Point(56, 137)
        txtmobilization.Name = "txtmobilization"
        txtmobilization.Size = New Size(238, 27)
        txtmobilization.TabIndex = 52
        ' 
        ' Btnsub
        ' 
        ...
        Btnsub.Location = New Point(640, 748)
        Btnsub.Name = "Btnsub"
        ...
        projectcost.Location = New Point(114, 747)
        projectcost.Name = "projectcost"
        projectcost.Size = New Size(311, 24)
        projectcost.TabIndex = 190
        ...
        lblstatus.Location = New Point(598, 85)
        lblstatus.Name = "lblstatus"
        lblstatus.Size = New Size(201, 84)
        lblstatus.TabIndex = 191
        lblstatus.Text = "PAID"
        lblstatus.Visible = False
        ' 
        ' Button3
        ' 
        Button3.Location = New Point(329, 759)
        ...
        ' Button2
        ' 
        Button2.Location = New Point(16, 759)
        ...
        ' Button1
        ' 
        Button1.Location = New Point(158, 758)
        Button1.Name = "Button1"
        Button1.Size = New Size(107, 47)
        Button1.TabIndex = 248
        ...
        ' txtseedproreport
        ' 
        txtseedproreport.Location = New Point(453, 759)
        ...
        GroupBox3.Location = New Point(419, 548)
        GroupBox3.Name = "GroupBox3"
        GroupBox3.Size = New Size(380, 172)
        GroupBox3.TabIndex = 254
        ...
        GroupBox2.Location = New Point(16, 537)
        GroupBox2.Name = "GroupBox2"
        GroupBox2.Size = New Size(380, 183)
        GroupBox2.TabIndex = 253
        ...
        GroupBox1.Location = New Point(419, 171)
        GroupBox1.Name = "GroupBox1"
        GroupBox1.Size = New Size(380, 360)
        GroupBox1.TabIndex = 252
        ...
        GroupBox4.Controls.Add(txtmobilization)
        ...
        GroupBox4.Location = New Point(16, 171)
        ...
        Label17.Location = New Point(52, 196)
        ...
        Label19.Location = New Point(52, 111)
        Label19.Name = "Label19"
        Label19.Size = New Size(220, 23)
        Label19.TabIndex = 57
        Label19.Text = "Less (15% Mobilization Fee)"
        ' 
        ' MenuStrip1
        ' 
        ...
        Name = "Disbursement_2nd"
        StartPosition = FormStartPosition.CenterScreen
        Text = "Disbursement_2nd"
    ...
    Friend WithEvents txtmobilization As TextBox
