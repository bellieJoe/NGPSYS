...
Public Class Disbursement_76_
    ...
    Private Sub Disbursement_76__Load(sender As Object, e As EventArgs) Handles MyBase.Load
        sitecode()
        displaypepc()
        displaydata()
        obdata()
        ...
        Try
            ...
            Else
                ...
                Using connection As New MySqlConnection(connectionString)
                    ...
                    Dim query As String = "INSERT INTO disbursement_76_tbl (unique_code, cheque_num,  date_issued, date_released, payment, total_cost, retention_fee, ob_no, ob_date, dv_no, dv_date)
    ...
    Private Sub displaypc()
        Dim connectionString As String = "server=localhost;username=root;password=;database=ngp"
        Dim query As String = "SELECT total_cost FROM disbursement_3rd_mf
    ...
    Private Sub displaypepc()
        Dim connectionString As String = "server=localhost;username=root;password=;database=ngp"
        Dim query As String = "SELECT SUM(total_contract) AS total_payment FROM plantation_estab_tbl WHERE unique_code = @id;"
    ...
    Private Sub displaydata()
        ...
        Dim connectionString As String = "server=localhost;username=root;password=;database=ngp"
        Dim query As String = "SELECT unique_code, cheque_num,  date_issued, date_released, payment, total_cost, retention_fee, ob_no, ob_date, dv_no, dv_date FROM disbursement_76_tbl
                                Where unique_code = @selectedvalue"
        Using connection As New MySqlConnection(connectionString)
            Using command As New MySqlCommand(query, connection)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        txtseedproreport.AppendText(vbTab + vbTab + vbTab + vbTab + vbTab & "3rd Quarter 76% Payment Report " + vbNewLine)
        txtseedproreport.AppendText("" + vbNewLine)
        txtseedproreport.AppendText("" + vbNewLine)
        txtseedproreport.AppendText("" + vbNewLine)
