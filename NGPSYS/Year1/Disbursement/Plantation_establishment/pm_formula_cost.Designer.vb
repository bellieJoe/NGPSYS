...
Partial Class pm_formula_cost
    ...
    Private Sub InitializeComponent()
        ...
        Panel1.Location = New Point(16, 57)
        Panel1.Name = "Panel1"
        ...
        Label2.Name = "Label2"
        Label2.Size = New Size(462, 39)
        Label2.TabIndex = 217
        Label2.Text = "Plantation Establishment Cost"
        ' 
        ' pm_formula_cost
        ' 
        ...
        Controls.Add(Label2)
        Name = "pm_formula_cost"
        Text = "pm_formula_cost"
