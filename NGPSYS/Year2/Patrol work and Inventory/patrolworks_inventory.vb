...
Public Class patrolworks_inventory

    Dim totaltarget As Double
    Dim itcom As Integer
    Dim qty As Double
    Dim unit As Double
    Private Sub patrolworks_inventory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub submit()
        ...
        Try
            ...
            command.Parameters.AddWithValue("@Value7", txttotalcost.Text.Replace(",", "").Trim())
