...
Public Class Year2_dashboard

    Dim progressresultsr As Integer


    Private Sub Year2_dashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        year2_inspection.AddTechnicalInspectionCommitteeToolStripMenuItem.Visible = True
        year2_inspection.ShowDialog()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        survival_rate_year2.btnsub1.Visible = True
        survival_rate_year2.btnsub2.Visible = False
        survival_rate_year2.btnsub3.Visible = False

        year2_remark.btn1.Visible = True
        year2_remark.btn2.Visible = False
        year2_remark.btn3.Visible = False

        If String.IsNullOrEmpty(txt1stquarter.Text) OrElse txt1stquarter.Text.Trim() = "0" Then
            year2_inspection.AddRingWeddingAndRestakingToolStripMenuItem.Visible = True
            year2_view.btnsubmit.Visible = True
            year2_view.btnsub2.Visible = False
            year2_view.btnsub3.Visible = False
            year2_inspection.ShowDialog()
        Else
            _1stand2nd_quarter.ShowDialog()
        End If
    ...
    Private Sub firstquarterchecker()
        ...
        Dim selectQuery As String = "SELECT COUNT(*) " &
                     ...
                     "WHERE t2.unique_code = @value AND t2.filter_code = 'qrt12';"
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        survival_rate_year2.btnsub1.Visible = False
        survival_rate_year2.btnsub2.Visible = True
        survival_rate_year2.btnsub3.Visible = False

        year2_remark.btn1.Visible = False
        year2_remark.btn2.Visible = True
        year2_remark.btn3.Visible = False

        If String.IsNullOrEmpty(txt3rdquarter.Text) OrElse txt3rdquarter.Text.Trim() = "0" Then
            year2_inspection.AddRingWeddingAndRestakingToolStripMenuItem.Visible = True
            year2_view.btnsub2.Visible = True
            year2_view.btnsubmit.Visible = False
            year2_view.btnsub3.Visible = False
            year2_inspection.ShowDialog()

        Else
            _3rd_quarter.ShowDialog()
        End If
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        survival_rate_year2.btnsub1.Visible = False
        survival_rate_year2.btnsub2.Visible = False
        survival_rate_year2.btnsub3.Visible = True

        year2_remark.btn1.Visible = False
        year2_remark.btn2.Visible = False
        year2_remark.btn3.Visible = True

        If String.IsNullOrEmpty(txt4thquarter.Text) OrElse txt4thquarter.Text.Trim() = "0" Then
            year2_inspection.AddRingWeddingAndRestakingToolStripMenuItem.Visible = True
            year2_view.btnsub3.Visible = True
            year2_view.btnsubmit.Visible = False
            year2_view.btnsub2.Visible = False
            year2_inspection.ShowDialog()
        Else
            _4th_quarter.ShowDialog()
        End If
    End Sub

    Private Sub Year2_dashboard_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
    ...
    Private Sub NdToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles NdToolStripMenuItem.Click
        year2_addpayment_frm.ShowDialog()
    End Sub
    ...
    Private Sub RdQuarterPaymentToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RdQuarterPaymentToolStripMenuItem.Click
        year2_viewpayment_frm.ShowDialog()
    End Sub
    ...
    Private Sub Displaysurvivalrating()
        Dim connectionString As String = "server=localhost;username=root;password=;database=ngp"
        Dim query As String = "SELECT survival_rate  FROM survival_rate_year2 WHERE unique_code = @id and filter_code = @value;"
