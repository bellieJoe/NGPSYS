...
Public Class _3rd_quarter
    Private Sub _3rd_quarter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub LoadReportquarter3()
        ...
        Try
            Year_3quarter_Report.ReportViewer1.RefreshReport()

            ' Load report files
            With Year_3quarter_Report.ReportViewer1.LocalReport
                .ReportPath = Application.StartupPath & "\report\year2_quarter3_MP.rdlc"
                .DataSources.Clear()
            End With
            ...
            Using connection As New MySqlConnection(connStr)
                ...
                Year_3quarter_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSDetails)
                Year_3quarter_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSReplanting)
                Year_3quarter_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSPatrol)
                Year_3quarter_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSSurvival)
            End Using

            ' Set display mode and zoom level
            Year_3quarter_Report.ReportViewer1.SetDisplayMode(Microsoft.Reporting.WinForms.DisplayMode.PrintLayout)
            Year_3quarter_Report.ReportViewer1.ZoomMode = ZoomMode.Percent
            Year_3quarter_Report.ReportViewer1.ZoomPercent = 30
    ...
    Public Sub parameters()
        Try
            ...
            Year_3quarter_Report.ReportViewer1.LocalReport.ReportPath = Application.StartupPath & "\report\year2_quarter3_MP.rdlc"

            ' Set the parameters to the ReportViewer control
            Year_3quarter_Report.ReportViewer1.LocalReport.SetParameters(reportParameters)
    ...
    Private Sub btnprintreport_Click(sender As Object, e As EventArgs) Handles btnprintreport.Click
        LoadReportquarter3()
        parameters()
        Year_3quarter_Report.ShowDialog()
    End Sub
