...
Public Class _1stand2nd_quarter
    ...
    Private Sub _1stand2nd_quarter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        user()
    ...
    Private Sub btnreplant_Click(sender As Object, e As EventArgs) Handles btnreplant.Click
    ...
    Private Sub btnpatrol_Click(sender As Object, e As EventArgs) Handles btnpatrol.Click
        Dim connectionString As String = "server=localhost;username=root;pasword=;database=ngp"
    ...
    Public Sub LoadReportquarter12()
        ...
        Try
            year2_quarter12_Report.ReportViewer1.RefreshReport()

            ' Load report files
            With year2_quarter12_Report.ReportViewer1.LocalReport
                .ReportPath = Application.StartupPath & "\report\year2_quarter12_MP.rdlc"
                .DataSources.Clear()
            End With
            ...
            Using connection As New MySqlConnection(connStr)
                ...
                year2_quarter12_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSDetails)
                year2_quarter12_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSReplanting)
                year2_quarter12_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSPatrol)
                year2_quarter12_Report.ReportViewer1.LocalReport.DataSources.Add(rptDSSurvival)
            End Using

            ' Set display mode and zoom level
            year2_quarter12_Report.ReportViewer1.SetDisplayMode(Microsoft.Reporting.WinForms.DisplayMode.PrintLayout)
            year2_quarter12_Report.ReportViewer1.ZoomMode = ZoomMode.Percent
            year2_quarter12_Report.ReportViewer1.ZoomPercent = 30
    ...
    Public Sub parameters()
        Try
            ...
            year2_quarter12_Report.ReportViewer1.LocalReport.ReportPath = Application.StartupPath & "\report\year2_quarter12_MP.rdlc"

            ' Set the parameters to the ReportViewer control
            year2_quarter12_Report.ReportViewer1.LocalReport.SetParameters(reportParameters)
    ...
    Private Sub Button4_Click_1(sender As Object, e As EventArgs) Handles btnprintreport.Click
        LoadReportquarter12()
        parameters()
        year2_quarter12_Report.ShowDialog()
    End Sub
